...
export default function App() {
  ...
  const handleFormSubmit = (e) => {
    ...
    const waUrl = `https://wa.me/${pageData.phone}?text=Halo%20Admin%20${encodeURIComponent(pageData.name)},%20saya%20${encodeURIComponent(name)}.%20Saya%20ingin%20sewa%20sepeda%20tipe%20*${encodeURIComponent(bikeType)}*%20untuk%20tanggal%20${encodeURIComponent(date)}%20selama%20${encodeURIComponent(duration)}.%20Catatan:%20${encodeURIComponent(notes || '-')}`;
    ...
    <>
      <main className="w-full max-w-[480px] mx-auto relative shadow-2xl bg-white min-h-screen overflow-hidden pb-28">
          ...
          <div className="absolute inset-0 z-0">
            <img 
              ...
              onError={(e) => {
                ...
                e.currentTarget.src = "https://images.unsplash.com/photo-1507035895480-2b3156c31fc8?auto=format&fit=crop&q=80&w=1200";
              }}
            />
          ...
          <div className="relative z-10 flex flex-col items-center text-center mt-32">
            <div className="w-28 h-28 rounded-full p-2 bg-white/95 backdrop-blur-md mb-6 shadow-2xl border-2 border-teal-500/50 overflow-hidden flex items-center justify-center">
              <img 
                ...
                onError={(e) => {
                  e.currentTarget.onerror = null;
                  e.currentTarget.src = "./logo-bycoz.png";
                }}
              />
            </div>
            ...
            <button 
              ...
              className="group relative flex items-center justify-center gap-2 w-full max-w-sm py-4 bg-teal-600 text-white rounded-xl font-bold text-[15px] hover:bg-teal-700 transition-all shadow-[0_8px_30px_rgba(13,148,136,0.3)] cursor-pointer"
            >
              <Bike size={20} />
              Mulai Sewa Sekarang
        ...
        <section id="booking-form" className="py-12 px-6 bg-teal-900 relative overflow-hidden">
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-2xl relative z-10">
            ...
            <form onSubmit={handleFormSubmit} className="flex flex-col gap-4">
              ...
              <button 
                type="submit"
                className="w-full mt-2 bg-[#25D366] text-white font-bold text-[15px] tracking-wide py-4 rounded-xl flex items-center justify-center gap-2 hover:bg-[#1EBE5D] transition-colors shadow-lg cursor-pointer"
              >
                Kirim via WhatsApp
        ...
        >
          <button 
            onClick={scrollToForm}
            className="w-full flex items-center justify-between px-6 py-4 bg-slate-900 backdrop-blur-xl border border-slate-700 rounded-2xl text-white shadow-2xl hover:bg-slate-800 active:scale-[0.98] transition-all cursor-pointer"
          >
